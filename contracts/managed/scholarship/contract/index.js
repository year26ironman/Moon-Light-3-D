...
export class Contract {
    ...
    this.circuits = {
      verify_eligibility: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(gpa_0).concat(_descriptor_0.toValue(income_0)),
  ...
  initialState(...args_0) {
    ...
    const initial_min_gpa_0 = args_0[1];
    const initial_max_income_0 = args_0[2];
    ...
    if (!(typeof(initial_min_gpa_0) === 'bigint' && initial_min_gpa_0 >= 0n && initial_min_gpa_0 <= 4294967295n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'scholarship.compact line 8 char 1',
                                 'Uint<0..4294967296>',
                                 initial_min_gpa_0)
    }
    if (!(typeof(initial_max_income_0) === 'bigint' && initial_max_income_0 >= 0n && initial_max_income_0 <= 4294967295n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'scholarship.compact line 8 char 1',
                                 'Uint<0..4294967296>',
                                 initial_max_income_0)
    }
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(0n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initial_min_gpa_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(initial_max_income_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _verify_eligibility_0(context, partialProofData, gpa_0, income_0) {
    __compactRuntime.assert(gpa_0
                            >=
